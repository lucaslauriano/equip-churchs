  ...
  return (
    <section className='px-8 pt-40 pb-20'>
      <div className='flex mb-16 flex-col items-center'>
        <h2 className='text-center mb-2 text-3xl' color='blue-gray'>
          O que outros pastores e líderes dizem.
        </h2>
        <h2 className='mb-3 w-full text-center font-normal !text-gray-500 lg:w-10/12'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut eu
          volutpat orci, a feugiat augue.
        </h2>
      </div>
          ...
          {new Array(2).fill('').map((_, i) => (
            ...
            >
              <div className='col-span-3 flex flex-col items-start justify-center'>
                <h2 color='white' className='mb-5 text-xl font-normal '>
                ...
                <h2 color='white' className='font-medium uppercase'>
                  Louis Miriam,{' '}
